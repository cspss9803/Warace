...
private:
	...
	FAsyncTask<OpenMySQLConnectionTask>*   OpenConnectionTaskPtr;
	FAsyncTask<UpdateMySQLQueryAsyncTask>* UpdateQueryAsyncTaskPtr;
	FAsyncTask<SelectMySQLQueryAsyncTask>* SelectQueryAsyncTaskPtr;
	FAsyncTask<UpdateMySQLImageAsyncTask>* UpdateImageAsyncTaskPtr;
	FAsyncTask<SelectMySQLImageAsyncTask>* SelectImageAsyncTaskPtr;
