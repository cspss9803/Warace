...
char* DLLManager::SelectImageFromQuery(int ConnectionID, FString Query, FString SelectParameter, FString& ErrorMessage)
{
	if (ImportMethod<_SelectImageFromQuery>("SelectImageFromQuery", m_SelectImageFromQueryFromDll))
	{
		...
		if(m_SelectImageFromQueryFromDll(ConnectionID, querychar, selectparameterchar, ichar, errormessage))
		{
